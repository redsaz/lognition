...
public class LabelSelectorParserTest {
  ...
  public static Iterable<Object[]> labels() {
    return Arrays.asList(
        ...
        new Object[] {
          "alpha in (1, two, 3, 4), beta in (5, six, 7, 8)",
          "alpha in (1, two, 3, 4), beta in (5, six, 7, 8);",
          "Test single in, multiple value"
        },
        new Object[] {"alpha notin (1)", "alpha notin (1);", "Test single notin, single value"},
        new Object[] {
          "alpha notin (1, 2, 3, 4)",
          "alpha notin (1, 2, 3, 4);",
          "Test single notin, multiple value"
        },
        new Object[] {
          "alpha notin (1, two, 3, 4), beta notin (5, six, 7, 8)",
          "alpha notin (1, two, 3, 4), beta notin (5, six, 7, 8);",
          "Test single in, multiple value"
        },
        new Object[] {
          "1j.2e_3b-4y=6a.7b_8c-9d",
          "1j.2e_3b-4y = 6a.7b_8c-9d;",
          "Test names and values can have dots, underscores, and dashes"
        },
        new Object[] {"12=12", "12 = 12;", "Test names and values can be purely numbers"},
        new Object[] {
          "alpha in (6a.7b_8c-9d)",
          "alpha in (6a.7b_8c-9d);",
          "Test in values can have dots, underscores, and dashes"
        },
        new Object[] {
        ...
        new Object[] {
          " alpha \t =\t\t 4\t ",
          "alpha = 4;",
          "Test a mixutre of whitespace (including at beginning and end) are acceptable."
        },
        new Object[] {

...
public class JtlTypeTest {
    ...
    public void testConvert(JtlType jtlType, String input, Object expected) {
        ...
        assertEquals(actual.getClass(), expected.getClass(), "Wrong conversion class for " + jtlType.name());
    ...
    public void testPutIn() {
        CsvJtlRow expected = new CsvJtlRow(1234L, 10L, "Label", "200", "OK",
                "Thread-1", "text", Boolean.TRUE,
                "This isn't normally here on success.", 100L, 10L, 10, 11,
                "http://www.redsaz.com", "file.csv", 11, 9, "UTF-8",
                1, 0, "redsaz", 1, "bob=1");

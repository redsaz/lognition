...
import com.redsaz.debitage.api.DebitageMediaType;
...
public class NotesResource {
     ...
     */
    @GET
    @Produces(DebitageMediaType.NOTES_V1_JSON)
     ...
     */
    @GET
    @Produces({DebitageMediaType.NOTE_V1_JSON})
    @Path("{id}/{uriName}")
    ...
    @POST
    @Consumes(DebitageMediaType.NOTES_V1_JSON)
    @Produces({DebitageMediaType.NOTES_V1_JSON})
    ...
    @POST
    @Consumes(DebitageMediaType.NOTE_V1_JSON)
    @Produces({DebitageMediaType.NOTE_V1_JSON})

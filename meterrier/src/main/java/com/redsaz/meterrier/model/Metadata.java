...
public class Metadata extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7645664639551853365L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Metadata\",\"namespace\":\"com.redsaz.meterrier.model\",\"fields\":[{\"name\":\"earliestMillisUtc\",\"type\":\"long\"},{\"name\":\"LatestMillisUtc\",\"type\":\"long\"},{\"name\":\"totalEntries\",\"type\":\"long\"}]}");
   ...
   */
  public static com.redsaz.meterrier.model.Metadata.Builder newBuilder() {
    return new com.redsaz.meterrier.model.Metadata.Builder();
  }
   ...
   * @return A new Metadata RecordBuilder
   */
  public static com.redsaz.meterrier.model.Metadata.Builder newBuilder(com.redsaz.meterrier.model.Metadata.Builder other) {
    return new com.redsaz.meterrier.model.Metadata.Builder(other);
  }
   ...
   * @return A new Metadata RecordBuilder
   */
  public static com.redsaz.meterrier.model.Metadata.Builder newBuilder(com.redsaz.meterrier.model.Metadata other) {
    return new com.redsaz.meterrier.model.Metadata.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Metadata>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.redsaz.meterrier.model.Metadata.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.redsaz.meterrier.model.Metadata other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.earliestMillisUtc)) {
        this.earliestMillisUtc = data().deepCopy(fields()[0].schema(), other.earliestMillisUtc);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.redsaz.meterrier.model.Metadata.Builder setEarliestMillisUtc(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.redsaz.meterrier.model.Metadata.Builder clearEarliestMillisUtc() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.redsaz.meterrier.model.Metadata.Builder setLatestMillisUtc(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.redsaz.meterrier.model.Metadata.Builder clearLatestMillisUtc() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.redsaz.meterrier.model.Metadata.Builder setTotalEntries(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.redsaz.meterrier.model.Metadata.Builder clearTotalEntries() {

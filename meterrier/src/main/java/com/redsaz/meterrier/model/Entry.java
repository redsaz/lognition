...
public class Entry extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.redsaz.meterrier.model.Entry.Builder newBuilder() {
    return new com.redsaz.meterrier.model.Entry.Builder();
  }
   ...
   * @return A new Entry RecordBuilder
   */
  public static com.redsaz.meterrier.model.Entry.Builder newBuilder(com.redsaz.meterrier.model.Entry.Builder other) {
    return new com.redsaz.meterrier.model.Entry.Builder(other);
  }
   ...
   * @return A new Entry RecordBuilder
   */
  public static com.redsaz.meterrier.model.Entry.Builder newBuilder(com.redsaz.meterrier.model.Entry other) {
    return new com.redsaz.meterrier.model.Entry.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Entry>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.redsaz.meterrier.model.Entry.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.redsaz.meterrier.model.Entry other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.item)) {
        this.item = data().deepCopy(fields()[0].schema(), other.item);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.redsaz.meterrier.model.Entry.Builder setItem(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.redsaz.meterrier.model.Entry.Builder clearItem() {
      item = null;

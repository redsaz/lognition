...
public class StatusCodeLookupTest {
  ...
  /**
   * Check that when a StatusCodeLookup is created with codes and messages, that we're able to
   * retrieve those codes and messages correctly.
   */
  @Test
  ...
  /**
   * Check that when a StatusCodeLookup is created with uneven number of codes and messages, an

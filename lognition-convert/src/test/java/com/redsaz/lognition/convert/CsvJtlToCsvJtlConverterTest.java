...
import static com.redsaz.lognition.convert.ConverterBaseTest.assertAvroContentEquals;
...
/**
 * Test the CSV-JTL to CSV-JTL converter (Usually this operation is one that simply removes columns,
 * but it could be a straight 1-to-1 if needed.
 *

 ...
 *
 * <p>This takes advantage of compact integer encoders for avro or protobuf that use zig-zag
 * variable-length integers. The normal status codes all have reference values of 0 to 63, and
 * custom status codes go from -64 to -127 (and further, if need be). This ensures that the status
 * code will fit in a single byte, instead of 4 like a normal integer would be (otherwise we're
 * actually WASTING a byte).
 */
class StatusCodeLookup {
  ...
  static {
    REF_TO_CODE =
        Arrays.asList(
            "0", "100", "101", "102", "200", "201", "202", "203", "204", "205", "206", "207", "208",
            "226", "300", "301", "302", "303", "304", "305", "307", "308", "400", "401", "402",
            "403", "404", "405", "406", "407", "408", "409", "410", "411", "412", "413", "414",
            "415", "416", "417", "418", "421", "422", "423", "424", "426", "428", "429", "431",
            "444", "451", "499", "500", "501", "502", "503", "504", "505", "506", "507", "508",
            "510", "511", "599");
    REF_TO_MESSAGE =
        Arrays.asList(
            "Unspecified",
  ...
  public StatusCodeLookup(
      Collection<CharSequence> inCustomCodes, Collection<CharSequence> inCustomMessages) {
    if ((inCustomCodes == null || inCustomCodes.isEmpty()) && inCustomMessages == null
        || inCustomMessages.isEmpty()) {
      customCodes = new ArrayList<>();
      customMessages = new ArrayList<>();
      return;

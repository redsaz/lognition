...
/**
 * Checks if the CSV (JTL) row is a header row or not. Sometimes (in JMeter
 * versions 2.12 and possibly earlier), when running JMeter in remote mode, the
 * CSV JTL file will not have a header row! The CSV JTL generated in this
 * fashion usually has the following defaults:
 * <pre>
 * timeStamp,elapsed,label,responseCode,responseMessage,threadName,dataType,success,bytes,grpThreads,allThreads,Latency
 * </pre> So, this utility can be used to check the first row of a CSV (JTL)
 * file and for the converter to act appropriately.
 *
...
/*package protected*/ class HeaderCheckUtil {
    ...
    public static final List<JtlType> DEFAULT_HEADERS = Arrays.asList(
    ...
    public static final String[] DEFAULT_HEADERS_TEXT = new String[]{
